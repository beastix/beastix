...
bootstrap-gcc: bootstrap-binutils
...
bootstrap-musl: bootstrap-gcc bootstrap-binutils
	export PATH=${BOOTSTRAP_PATH}; export CC=${BOOTSTRAP_CC}; cd ${SRC_ROOT}/world/musl; ./configure ${BOOTSTRAP_CONFIG} --syslibdir=${BOOTSTRAP_TOOLS}/lib --host="x86_64-unknown-linux-musl" \
